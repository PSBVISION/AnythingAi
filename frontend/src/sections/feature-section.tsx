...
export const FeatureSection = () => {
    return (
        <div className="flex flex-col items-center justify-center">
            <div className="py-24">
                <SectionTitle
                    title="Why Choose Anything.ai?"
                    description="Our AI agents do more than analyze — they execute workflows, automate decisions, and trigger actions across systems with full transparency."
                />
            </div>
